...
class EmbeddingEvaluator:
    ...
    def run_evaluation(self, 
                      ...
                      top10_output_file: str = "top10_relevant_documents.json") -> Dict[str, Union[Dict, List]]:
        """
        ...
        self._display_results(self.model.model_name, metrics, sample_results, output_path, csv_paths, top10_path)
