...
class VietnameseEmbeddingModel:
    """Vietnamese document embedding model using HuggingFace transformers."""
...
class CSVLogger:
    ...
    def _initialize_csv_files(self) -> None:
        ...
        with open(self.metrics_csv, 'w', newline='', encoding='utf-8') as f:
            writer = csv.writer(f)
            writer.writerow([
                'timestamp', 'model_name', 'max_seq_length', 'device', 'num_questions', 
    ...
    def log_metrics(self, model_info: Dict, dataset_stats: Dict, metrics: Dict) -> None:
        ...
        with open(self.metrics_csv, 'a', newline='', encoding='utf-8') as f:
            ...
            writer.writerow([
                ...
                model_info.get('max_seq_length', 0),
...
class EmbeddingEvaluator:
    ...
    def __init__(self, 
        ...
        self.model = VietnameseEmbeddingModel(model_name, max_seq_length, device)
    ...
    def run_evaluation(self, 
        ...
        self._display_results(model_info, metrics, sample_results, output_path, csv_paths)
    ...
    def _display_results(self, 
        ...
        print(f"Max sequence length: {model_info['max_seq_length']:,} tokens")
